...
var MarketingSiteStarter = window.MarketingSiteStarter ? window.MarketingSiteStarter : {};

MarketingSiteStarter.util = {
    /*
...
$.extend(MarketingSiteStarter, {
    ...
    */
    commonInit: function() {
        MarketingSiteStarter.util.iosZoomWorkaround();
        $(".show-nav-menu").flyout();
        $("nav a").animatescroll();
    }
});
